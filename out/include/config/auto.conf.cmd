deps_config := \
	...
	drivers/iio/imu/st_asm330lhhx/Kconfig \
...
ifneq "$(KERNELVERSION)" "6.1.130"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/aryan/toolchains/neutron-clang/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/aryan/toolchains/neutron-clang/bin/ld.lld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
...
ifneq "$(NM)" "/home/aryan/toolchains/neutron-clang/bin/llvm-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/aryan/toolchains/neutron-clang/bin/llvm-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "/home/aryan/toolchains/neutron-clang/bin/llvm-ar"
include/config/auto.conf: FORCE
endif
